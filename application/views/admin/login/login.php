...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="UNNO, Ingreso">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Home</title>
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/Casa.css" media="screen">
    ...
    <script src="https://kit.fontawesome.com/9c0131a85f.js" crossorigin="anonymous"></script>
  ...
  <body class="u-body">
    <section class="u-align-left u-clearfix u-image u-shading u-section-1" src="" data-image-width="1280" data-image-height="960" id="sec-4c14">
